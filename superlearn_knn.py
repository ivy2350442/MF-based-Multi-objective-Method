...
def main():
    ...
    for test in range(cv):
        ...
        #knn
        s_knn = KNeighborsClassifier(n_neighbors=6, p = 1)
        t_knn = KNeighborsClassifier(n_neighbors=3)
        r_knn = KNeighborsClassifier(n_neighbors=3, p = 1)
        ent_knn = KNeighborsClassifier(n_neighbors=2, p = 1)
        g_knn = KNeighborsClassifier(n_neighbors=3, p = 1)
        e_knn = KNeighborsClassifier(n_neighbors=3)
        ...
        if test == 3:
            ...
            plt.savefig("KNN.pdf", format='pdf', dpi=1000)
            plt.show()
