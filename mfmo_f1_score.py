...
def mfmo(tr_f, tr_t, te_f, te_t):
    ...
    plt.plot(te_s_fpr, te_s_tpr, 'C4', label = 'Shopping', linewidth=2)
    plt.plot(te_t_fpr, te_t_tpr, 'C5', label = 'Travel', linewidth=2)
    plt.plot(te_r_fpr, te_r_tpr, 'C6', label = 'Restaurant and Dining', linewidth=2)
    plt.plot(te_ent_fpr, te_ent_tpr, 'C1', label = 'Entertainment', linewidth=2)
    plt.plot(te_g_fpr, te_g_tpr, 'C2', label = 'Games', linewidth=2)
    plt.plot(te_e_fpr, te_e_tpr, 'C3', label = 'Education', linewidth=2)
    ...
    plt.savefig("MF.pdf", format='pdf', dpi=1000)
    plt.show()
